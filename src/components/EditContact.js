...
const { id } = useParams();
  ...
  useEffect(() => {
    ...
    const handleContactEdit =(e)=> {
      ...
      const filterOut = prevData.filter((contact) => contact.contact.id !== id);
      localStorage.setItem('contacts', JSON.stringify([...filterOut, {contact}]))
      navigate('/');
    }
  ...
  return (
    <div className='container'>
        ...
        <label>Name</label>
          <input id="name" type="text" className='form-control' name="name" value={name} onChange={handleChange}></input>
        </div>
        <div className='form-group'>
        <label>Phone</label>
          <input id="phone" type="phone" className='form-control' name="phone" value={phone} onChange={handleChange}></input>
        </div>
        <div className='form-group'>
        <label>Company</label>
        <input id="company" type="text" className='form-control' name="company" value={company} onChange={handleChange}></input>
        </div>
        <div className='form-group'>
        <label>Address</label>
        <input id="address" type="text" className='form-control' name="address" value={address} onChange={handleChange}></input>
        </div> <br></br>
